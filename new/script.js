...
const I18N = {
    en: {
        ...
        heroSubtitle: 'Improve both RPP and organic search! Visualize keyword rankings to build your strategy.',
    ...
    ja: {
        ...
        heroSubtitle: "RPPと自然検索がともに改善できる！キーワードごとの検索順位を可視化して、戦略立案。",
